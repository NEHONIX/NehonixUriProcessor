...
} from "./REACT.NehonixDomProcessor";
import {
...
import { NehonixShieldProvider } from "./REACT.NehonixShield";
...
export const NehonixShieldProviderPlugging: React.FC<{
  ...
  // Import the actual providers dynamically to avoid circular dependencies
          ...
          <div>
            ...
            <div style={{ fontSize: "0.8em", marginTop: 5 }}>
              ...
              {securityStatus.activeThreats.length > 0 && (
                <div>Active threats: {securityStatus.activeThreats.length}</div>
              )}
            </div>
            <button
